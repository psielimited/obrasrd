      ...
      <div className="px-4 md:px-6 py-4">
        <div className="flex items-start justify-between gap-3">
          <div className="flex items-start gap-3">
            <Button variant="ghost" size="icon" className="lg:hidden text-foreground hover:bg-muted" onClick={onOpenSidebar}>
              <Menu className="h-5 w-5" />
            </Button>
            <div>
              <h1 className="text-xl md:text-2xl font-extrabold tracking-tight text-foreground">{title}</h1>
        ...
        <div className="mt-4 flex flex-col md:flex-row md:items-center gap-3">
          ...
          <div className="flex items-center gap-2 md:ml-auto">
            <Link to="/notificaciones" className="relative inline-flex">
              <Button variant="outline" size="icon" className="border-border bg-muted text-foreground hover:bg-muted">
            ...
            <div className="text-right px-2">
              ...
              <p className="text-sm font-semibold text-foreground truncate max-w-40">{identity}</p>
            </div>
          </div>
        </div>
      </div>
